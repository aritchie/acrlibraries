...
namespace Acr.Reflection {
    ...
    public static class AttributeUtil {
        ...
        public static IEnumerable<T> GetAttributes<T>(this PropertyInfo property, bool inherited = true) where T : Attribute {
        ...
        public static IEnumerable<T> GetAttributes<T>(this ParameterInfo param, bool inherited = true) where T : Attribute {
